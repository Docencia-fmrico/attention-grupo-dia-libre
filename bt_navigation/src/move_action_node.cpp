...
public:
  ...
  : plansys2::ActionExecutorClient("move_location", 500ms)
  {
    ...
    wp.header.stamp = now();
    wp.pose.position.x = -9.93;
    wp.pose.position.y = -14.1;
    ...
    wp.pose.position.x = 0.924;
    wp.pose.position.y = -5.02;
    waypoints_["room2"] = wp;

    wp.pose.position.x = -0.472;
    wp.pose.position.y = -10.6;
    waypoints_["room3"] = wp;

    wp.pose.position.x = -5.19;
    wp.pose.position.y = -6.32;
    waypoints_["room4"] = wp;

    wp.pose.position.x = -3.09;
